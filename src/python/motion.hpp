  ...
  namespace python
  {
	...
	return boost::python::incref(boost::python::object(m_fx).ptr());
      ...
      void visit(PyClass& cl) const 
      {
        ...
        .def("se3Action",&MotionPythonVisitor::SE3ActOn)
        .def("se3ActionInverse",&MotionPythonVisitor::SE3InvActOn)
      ...
      static Vector6_fx getVector(const Motion_fx & self) { return self.coeffs(); }
      static void setVector(Motion_fx & self, const Vector6_fx & v) { self = v; }
      
      static Motion_fx SE3ActOn(const Motion_fx & self, const SE3_fx & M) { return self.SE3ActOn(M); }
      static Motion_fx SE3InvActOn(const Motion_fx & self, const SE3_fx & M) { return self.SE3InvActOn(M); }
