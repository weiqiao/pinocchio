...
BOOST_AUTO_TEST_CASE (vsRX)
{
  ...
  BOOST_CHECK(dataRevoluteUnaligned.f[1].coeffs().isApprox(dataRX.f[1].coeffs()));
  ...
  BOOST_AUTO_TEST_CASE (vsPX)
  {
    ...
    BOOST_CHECK(dataPrismaticUnaligned.f[1].coeffs().isApprox(dataPX.f[1].coeffs()));
  ...
  BOOST_AUTO_TEST_CASE (vsFreeFlyer)
  {
    ...
    BOOST_CHECK(dataFreeFlyer.f[1].coeffs().isApprox(dataSpherical.f[1].coeffs()));
  ...
  BOOST_AUTO_TEST_CASE (vsFreeFlyer)
  {
    ...
    BOOST_CHECK(dataFreeFlyer.f[1].coeffs().isApprox(dataTranslation.f[1].coeffs()));
